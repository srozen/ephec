...
cam.saveSnapshot("c:/test/AAA1.jpg")

im1 = Image.open("c:/test/AAA1.jpg")
...
Copie1.save("c:/test/seuil1.jpg")

#################  image 2  #################

cam.saveSnapshot("c:/test/AAA2.jpg")

im2 = Image.open("c:/test/AAA2.jpg")
